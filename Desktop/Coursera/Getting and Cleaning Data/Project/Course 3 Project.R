...
##Combined final is the final dataset so far
...
write.table(summarized,"C:/Users/kdavison/Desktop/Coursera/Getting and Cleaning Data/Project/Final_table.txt",sep="\t")